...
<body>
    ...
    <main>
        <ul class="wrapper">
            ...
            <li class="picture1">
                <img class="picture" src="/img/<?php echo ($favorite_shoulder_rank[0]["list_image"]); ?>" />

                <p><img src="/img/<?php echo '142136.png' ?>" class="kiretemasu" alt="">
                    <?php echo ($favorite_shoulder_rank[0]['count']) . 'マッスル' ?>
                </p>
            </li>
            <li class="message">message<br /><?php echo ($favorite_shoulder_rank[0]['post_message']) ?><br />
                <?php foreach ($favorite_shoulder_rank as $value) : ?>
                ...
                <?php endforeach; ?>
            <li class="myTraning">マイトレーニング<br /><?php echo ($favorite_shoulder_rank[0]['mytraining']) ?></li>
            <li class="myFood">フード<br /><?php echo ($favorite_shoulder_rank[0]['mymenu']) ?></li>
            ...
            <li class="name_no2">
                ...
                <?php
                $num1 = 0;
                for ($i = 1; $i <= count($favorite_shoulder_rank); $i++) {
                    if ($favorite_shoulder_rank[0]['post_id'] !== $favorite_shoulder_rank[$i]['post_id']) {
                        echo ($favorite_shoulder_rank[$i]['user_name']);
                        $num1 = $i;
                        break;
                    }
                }
            ...
            <li class="picture2"><img class="picture" src="/img/<?php echo ($favorite_shoulder_rank[$num1]["list_image"]); ?>" />
                <p><img src="/img/<?php echo '142136.png' ?>" class="kiretemasu" alt="">
                    <?php echo ($favorite_shoulder_rank[$num1]['count']) . 'マッスル' ?>
                </p>
            </li>
            ...
            <li class="name_no3">
                ...
                <?php
                $num2 = 0;
                for ($i = $num1 + 1; $i <= count($favorite_shoulder_rank); $i++) {
                    if ($favorite_shoulder_rank[$num1]['post_id'] !== $favorite_shoulder_rank[$i]['post_id']) {
                        echo ($favorite_shoulder_rank[$i]['user_name']);
                        $num2 = $i;
                        break;
                    }
            ...
            <li class="picture3">
                ...
                <p><img src="/img/<?php echo '142136.png' ?>" class="kiretemasu" alt="">
                    <?php echo ($favorite_shoulder_rank[$num2]['count']) . 'マッスル' ?>
                </p>
            </li>
