        ...
        <ul class="wrapper">
            ...
            <li class="name_no3">
                ...
                <?php if (!empty($favorite_abs_rank[$num1 + 1]['post_id'])) : ?>
                    $num2 = 0;
                    for($i=$num1+1;$i<=count($favorite_abs_rank);$i++){ if($favorite_abs_rank[$num1]['post_id']!==$favorite_abs_rank[$i]['post_id']){ echo ($favorite_abs_rank[$i]['user_name']); } $num2=$i; break; } <img src="/img/<?php echo '142136.png' ?>" class="kiretemasu">
