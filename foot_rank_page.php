...
<head>
    <link rel="stylesheet">
    <?php echo link_tag("/assets/kinsta_css/footRank_style.css"); ?>
</head>
<body>
<nav class="underNav">
                <ul class="underTab">
    ...
    <main>
        <ul>
            <li class="title">今週の"素敵な足マッチョ"達</li>
    ...
    <script type="text/javascript" src="<?php echo ("/assets/kinsta_js/footRankPage.js"); ?>"></script>
</body>
</html>